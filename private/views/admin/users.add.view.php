    ...
    <div class="bodyContainer01">
        ...
        <div class="bodyContainer02">
            <form method="POST">
                ...
                <input type="text" name="RegistrationNo" class="reg" id="reg" value="<?=get_var('RegistrationNo')?>" required>

                <label for="firstName" class="firstNameLabel">First Name</label>
                <input type="text" name="FirstName" class="firstName" id="firstName" value="<?=get_var('FirstName')?>" required>

                <label for="middleName" class="middleNameLabel">Middle Name</label>
                <input type="text" name="MidName" class="middleName" id="middleName" value="<?=get_var('MidName')?>" required>

                <label for="lastName" class="lastNameLabel">Last Name</label>
                <input type="text" name="LastName" class="lastName" id="lastName" value="<?=get_var('LastName')?>" required>
                ...
                <input type="date" name="Birthday" class="birthday" id="Birthday" value="<?=get_var('Birthday')?>" required>


                <label for="address" class="addressLable" >Address</label>
                <textarea name="Address" class="address" id="address" cols="30" rows="10" value="<?=get_var('Address')?>" required></textarea>
                ...
                <select id="memberType" class="memberType" name="MemberType" required>
                    ...
                    <option <?=get_select('MemberType','Administrator')?> value="Administrator">Administrator</option>
                    <option <?=get_select('MemberType','Librarian')?> value="Librarian">Librarian</option>
                    <option <?=get_select('MemberType','Library-Staff')?> value="Library-Staff">Library-Staff</option>
                ...
                <div class="form-box">
                    ...
                    <div id="lectureForm" class="toggleForm">
                        ...
                        <select id="lecType" class="lecType" name="LecType">
                            ...
                            <option <?=get_select('LecType','Permanent Lecturer')?> value="Permanent Lecturer">Permanent Lecturer</option>
                            <option <?=get_select('LecType','Assistance Lecturer')?> value="Assistance Lecturer">Assistance Lecturer</option>
                        ...
                        <select id="subject" class="subject" name="Subject">
                            ...
                            <option <?=get_select('Subject','Operating System')?> value="Operating System">Operating System</option>
                            <option <?=get_select('Subject','Computer System')?> value="Computer System">Computer System</option>
                            <option <?=get_select('Subject','Computer Network')?> value="Computer Network">Computer Network</option>
                            <option <?=get_select('Subject','Artificial Intelligence')?> value="Artificial Intelligence">Artificial Intelligence</option>
                            <option <?=get_select('Subject','Programming Language C')?> value="Programming Language C">Programming Language C</option>
                        </select>
                    ...
                    <div id="studentForm" class="toggleForm">
                        ...
                        <select id="stuType" class="stuType" name="StudentType">
                            ...
                            <option <?=get_select('StudentType','1-3 Year Student')?> value="1-3 Year Student">1-3 Year Student</option>
                            <option <?=get_select('StudentType','4th Year Student')?> value="4th Year Student">4th Year Student</option>
                            <option <?=get_select('StudentType','Research Student')?> value="Research Student">Research Student</option>
                        </select>
                        ...
                        <select id="degree" class="degree" name="Degree">
                            ...
                            <option <?=get_select('Degree','Computer Science (CS)')?> value="Computer Science (CS)">Computer Science (CS)</option>
                            <option <?=get_select('Degree','Information System (IS)')?> value="Information System (IS)">Information System (IS)</option>

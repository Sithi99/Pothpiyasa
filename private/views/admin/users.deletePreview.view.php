    ...
    <div class="bodyContainer01">
        ...
        <div class="bodyContainer02">
            ...
            <form method="POST">
                ...
                <button class="deletememberbtn" name="deleteMember" type="submit" style="text-decoration: none; color: white;"><a href="<?=ROOT?>/users/delete/<?= $row[0]->UserID?>">Delete</a></button>

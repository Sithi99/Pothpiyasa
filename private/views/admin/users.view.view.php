...
<body>
        ...
        <?php foreach ($rows as $row): ?>
                <tr>
                        ...
                        <td><?=get_user_name('AddStaffID',$row->AddStaffID)?></td>

                        <td><button type='button' class='editbtn' id='editbtn'><i class='fa-solid fa-pen'></i>&nbsp;<a href='<?= ROOT?>/users/edit/<?=$row->UserID?>'> Edit</a></button> 
                        <button type='button' class='deletebtn' id='deletebtn'  disabled><i class='fa-solid fa-trash'></i>&nbsp;<a href='<?= ROOT?>/users/delete/<?=$row->UserID?>'> Delete</a></button></td> ";

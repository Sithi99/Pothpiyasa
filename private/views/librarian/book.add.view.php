...
<div class="bodyContainer02">
    ...
    <form  method="post" enctype="multipart/form-data">
        ...
        <select id="category" class="category" name="Category" id="category" value="<?= get_var('Category') ?>" required>
            ...
            <?php
                ...
                for ($i=0; $i < count($data); $i++) { 
                    echo "<option ". get_select('Category',$data[$i]->Name) . " value='".$data[$i]->CategoryID."'" .">".$data[$i]->Name."</option>"; 
                }
        ...
        <button class="addbookbtn" id="addbookbtn" name="submit" type="submit" onclick="getpopup()">Add Book</button>

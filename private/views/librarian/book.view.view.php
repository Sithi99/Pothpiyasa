        ...
        <div class="bodyContainer01">
            <?php 
                ...
                for ($i=0; $i < count($data2); $i++) { 
                    ...
                    $table .="<td><a href='".ROOT."/books/viewSpecific/".$data2[$i]->BookID."'>{$data2[$i]->Title}</td>";
                    ...
                    $table.="<td><button type='button' class='editbtn' id='editbtn'><i class='fa-solid fa-pen'></i>&nbsp;<a href='".ROOT."/books/edit/".$data2[$i]->BookID."'> Edit</a></button> <button type='button' class='deletebtn' id='deletebtn'  disabled><i class='fa-solid fa-trash'></i>&nbsp;<a href='".ROOT."/books/delete/".$data2[$i]->BookID."'> Delete</a></button></tr> ";
                }
                $table .= '</table>';
                echo $table;
